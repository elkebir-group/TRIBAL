...
1. *Isotype transition probability inference:* 
    + **Input**:  
        ...
        - `outtree` file generated by dnapars containing the Newick string of each input tree. **Note: we are currently working to integrate this step within our package.**
